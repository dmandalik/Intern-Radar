...
<div class="shell-card rounded-[1.6rem] p-4">
  ...
  <div class="grid gap-4 xl:grid-cols-3">
    <section class="glass-panel rounded-[1.3rem] p-4">
      <div class="section-eyebrow">Find</div>
      <div class="mt-3 grid gap-3">
        ...
        <div class="grid gap-3 sm:grid-cols-2">
          ...
          <select class="surface-input" on:change={(event) => updateNumber("year", (event.currentTarget as HTMLSelectElement).value)}>
    ...
    <section class="glass-panel rounded-[1.3rem] p-4">
      <div class="section-eyebrow">Rank</div>
      <div class="mt-3 grid gap-3">
